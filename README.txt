...
This will train the model on the Brown corpus, then predict the POS tags for the sentences in the Brown development data. There will be three output files:
    ...
    tagged_sentences.txt: a file containing all of the sentences that were tagged by viterbi

The console will display the accuracy of the model compared to the tagged development data. Current state of the art POS taggers achieve ~97% 
accuracy, while this achieves an accuracy of 93.3%
